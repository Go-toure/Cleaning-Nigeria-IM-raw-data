...
# optional QA export
export_reason_review <- TRUE
reason_review_file <- "C:/Users/TOURE/Mes documents/REPOSITORIES/IM_raw_data/IM_level/NIE_IM_reason_review.csv"
...
if (export_reason_review) {
  ...
  write_csv(reason_review, reason_review_file)
}
...
if (export_reason_review) {
  cat("\nReason review file successfully written to:\n", reason_review_file, "\n")
}