...
detect_main_reason <- function(x) {
  ...
  case_when(
    ...
    str_detect(
      x0,
      "not revisited|never revisited|no revisit|no revisitation|not come back|did not come back|didn t come back|team did not come back|team didn t come back|no follow up|no follow up visit|no follow up visit|missed but not revisited|revisit not done|team wrote revisit but never revisited|team wrote revisited but never revisited|household not revisited"
    ) ~ "r_house_not_revisited",
